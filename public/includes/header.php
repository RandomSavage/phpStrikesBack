<header>
  <nav>
    ...
    <a href="portfolio.php" class="<?php echo ($location == '/portfolio.php') ? 'active' : ''; ?>">Portfolio</a>
    <a href="calculator.php" class="<?php echo ($location == '/calculator.php') ? 'active' : ''; ?>">Calculator</a>
  </nav>
</header>
